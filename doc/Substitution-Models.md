...
> **TIP**: Applying a single morphological model to morphological data with heterogeneity of state space among characters may not be appropriate in some cases (e.g., [Khakurel et al., 2024]; [Mulvey et al., 2025]; [Huang, 2025]), and users may need to partition the data by the number of states in each character before analyzing them in IQ-TREE. For information on how to analyze partitioned morphological data in IQ-TREE, as well as some caveats, please refer to [davidcerny/GEOS26100-Fall2022], <https://davidcerny.github.io/post/teaching_revbayes/>, and [ej91016/MorphoParse].
{: .tip}
...
[Huang, 2025]: https://doi.org/10.1101/2025.04.22.650124
